 ...
 */
/*
static int polling_trip_temp1 = 9999;
static int polling_trip_temp2 = 9999;
static int polling_factor1 = 9999;
static int polling_factor2 = 9999;
*/
...
{
/*	seq_printf(m,
		"[mt6357tsbuck1_read] trip_0_temp=%d,trip_1_temp=%d,trip_2_temp=%d,trip_3_temp=%d,\n",
...
/*	int len = 0;
	...
	&ptr_mt6357tsbuck1_data->time_msec) == 32) {
		...
		down(&sem_mutex);
		mtktspmic_dprintk(
			"[mt6357tsbuck1_write] mt6357tsbuck1_unregister_thermal\n");
		...
		mtktspmic_dprintk(
			...
			g_THERMAL_TRIP[9]);
		mtktspmic_dprintk(
			"[mt6357tsbuck1_write] cooldev0=%s,cooldev1=%s,cooldev2=%s,cooldev3=%s,cooldev4=%s,",
			g_bind0, g_bind1, g_bind2, g_bind3, g_bind4);
		mtktspmic_dprintk(
		...
		mtktspmic_dprintk(
			"[mt6357tsbuck1_write] trip_0_temp=%d,trip_1_temp=%d,trip_2_temp=%d,trip_3_temp=%d,",
			trip_temp[0], trip_temp[1], trip_temp[2], trip_temp[3]);
		mtktspmic_dprintk(
