 ...
 **************************************************/
#define SEG2_GPU_DVFS_FREQ0			(740000)/* KHz */
#define SEG2_GPU_DVFS_FREQ1			(600000)/* KHz */
#define SEG2_GPU_DVFS_FREQ2			(550000)/* KHz */

#define SEG2_GPU_DVFS_VOLT0			(100000)	/* mV x 100 */
#define SEG2_GPU_DVFS_VOLT1			(90000)	/* mV x 100 */
#define SEG2_GPU_DVFS_VOLT2			(85000)	/* mV x 100 */

#define SEG2_GPU_DVFS_VSRAM0			(99500)	/* mV x 100 */
#define SEG2_GPU_DVFS_VSRAM1			(99500)	/* mV x 100 */
#define SEG2_GPU_DVFS_VSRAM2			(99500)	/* mV x 100 */

/**************************************************
 * MT6765 segment_3 : GPU DVFS OPP table Setting
 **************************************************/
#define SEG3_GPU_DVFS_FREQ0			(740000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ1			(650000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ2			(550000)	/* KHz */

#define SEG3_GPU_DVFS_VOLT0			(100000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT1			(90000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT2			(85000)		/* mV x 100 */

#define SEG3_GPU_DVFS_VSRAM0			(99500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VSRAM1			(99500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VSRAM2			(99500)		/* mV x 100 */
